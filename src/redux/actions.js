...
export const ADD_NEW_OFFICER_REQUEST = "ADD_NEW_OFFICER_REQUEST";
export const ADD_NEW_OFFICER_SUCCESS = "ADD_NEW_OFFICER_SUCCESS";
export const ADD_NEW_OFFICER_ERROR = "ADD_NEW_OFFICER_ERROR";

export const DELETE_OFFICER_REQUEST = "DELETE_OFFICER_REQUEST";
export const DELETE_OFFICER_SUCCESS = "DELETE_OFFICER_SUCCESS";
export const DELETE_OFFICER_ERROR = "DELETE_OFFICER_ERROR";
